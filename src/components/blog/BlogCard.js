	...
	return (
		<div className="blog-card">
			...
			<div className="blog-text-container">
				...
				<p className="blog-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. At dolor tincidunt tristique amet. Vel sed ac tortor consectetur vel euismod donec tortor. Molestie urna ultrices </p>
