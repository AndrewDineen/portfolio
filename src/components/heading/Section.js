...
const Section = () => {
	const Intro = {
		...
		paragraph: "I'm a consultant seeking employment as a backend software engineer. When I'm not programming, I like to read and study interesting academic subjects.",
		link: "My story"
	}
